...
def process_card(card):
    ...
    # Images - FIX: prende la prima immagine corrispondente con [0]
    og_id = card_info["id"]
    images = card["card_images"]
    main_images = [image for image in images if image["id"] == og_id][0]
    card_info.update(
        {
...
print("Fatto! File generati: cards.csv, cards_cardsets.csv, cards_variants.csv")